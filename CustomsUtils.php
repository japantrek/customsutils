...
class CustomsUtils
{
    ...
    public static function getRecycleRate($ageClass, $privateUse = true, $lightVehicle = true, $volume = 0, $mass = 0, $electro = false)
    {
        $rates = array(
            ...
            // Юрлица и физлица кроме как для личного пользования
            '2.a' => array(4.06, 10.36), // <= 1.0l
            '2.b' => array(15.03, 26.44), // <= 2.0l
            '2.c' => array(42.24, 63.95), // <= 3.0l
            '2.d' => array(48.5, 74.25), // <= 3.5l
            '2.e' => array(61.76, 81.19), // > 3.5l
            ...
            '3.d' => array(48.5, 74.25), // <= 3.5l
            '3.e' => array(61.76, 81.19), // > 3.5l
            ...
            '8.' => array(4.96, 13.52),
            '9.' => array(5.63, 19.67),
            '10.a' => array(9.64, 39.32), // седельные тягачи до 20t
            '10.b' => array(5.67, 23.13), // седельные тягачи до 20t c евро-6
            '11.' => array(4,74, 19,67), // самосвалы до 20t
            '12.' => array(5,75, 19.67), // автофургоны до 20t
        );
